...
.backImg {
	background: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, .4)),
		url("/HospitalManagementSystem/Images/hospital_3.png");
	height: 20vh;
	width: 100%;
			...
			<div class="col-md-6 offset-md-3">
				<div class="card paint-card">
					<div class="card-body">
						...
						%>
						<form class="row" action="/HospitalManagementSystem/UpdateStatus" method="post">
							<div class="col-md-6">
							...
							<div class="col-md-6">
								...
								<% String comment = ap.getStatus().equals("Pending") ? "" : ap.getStatus(); %>
 							<div class="col-md-12"> 
 								<br> <label>Comment</label> 
							<textarea required name="comm" class="form-control" row="3" 
									cols=""><%=comment %></textarea>
							</div>
